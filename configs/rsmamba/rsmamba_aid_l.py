...
work_dir = 'work_dirs/rsmamba_aid_l'


data_root = '/path_to_data/rsmamba/data/AID'
code_root = '/path_to_data/rsmamba/datainfo/AID'
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project='rsmamba', group='AID', name='rsmamba_aid_l'))
                ]
